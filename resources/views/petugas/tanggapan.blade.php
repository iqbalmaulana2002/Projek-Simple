...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md">
            ...
            <form method="post" action="{{url('/petugas/tanggapan/'.$pengaduan->id_pengaduan)}}">
                @csrf
                ...
                <div class="form-group row float-right">
                    <div class="col-md mt-4 mb-5">
                        <a href="{{url('/petugas/detail_pengaduan/'.$pengaduan->id_pengaduan)}}" class="btn btn-outline-primary btn-light">Kembali</a>
