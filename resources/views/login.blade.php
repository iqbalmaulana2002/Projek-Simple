            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="{{asset('login-regis/images/signin-image.jpg')}}" alt="sing up image"></figure>
                        <a href="{{asset('/register')}}" class="signup-image-link">Belum Punya Akun? Buat Akun</a>
                    </div>
