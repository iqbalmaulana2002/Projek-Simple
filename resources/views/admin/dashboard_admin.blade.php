...
<ul class="nav mb-2">
    <li class="nav-item mr-1">
        <a href="{{url('/admin/export_pdf')}}" class="btn btn-danger" onclick="return confirm('Download PDF?');">Export PDF</a>
    </li>
</ul>
                    ...
                    <table class="table no-wrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$msy->status}}</td>
                                <td>
                                    <a href="{{url('/admin/detail_pengaduan/'.$msy->id_pengaduan)}}" class="btn btn-primary font-weight-bold">
                                    <i class="fas fa-search-plus"></i> <span class="d-none d-md-inline">Detail</span></a>
                                    @if($msy->status != 'selesai')
                                        <a href="{{url('/admin/tanggapan/'.$msy->id_pengaduan)}}" class="btn btn-success font-weight-bold">
