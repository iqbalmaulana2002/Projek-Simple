...
<div class="container">
	...
	<div class="text-center mt-3 mb-5 pb-5">
        ...
        <form method="post" action="<?php echo e(url('/admin/data_pengaduan/'.$pengaduan->id)); ?>" class="d-inline">
            <?php echo csrf_field(); ?>
            ...
            <a class="btn btn-success" href="<?php echo e(url('/admin/tanggapan/'.$pengaduan)); ?>"><i class="fas fa-check"></i> Tanggapi</a>
        </form>
	</div>
    
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../tamplate_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\pengaduan_fix\resources\views/admin/detail.blade.php ENDPATH**/ ?>