                    ...
                    <table class="table no-wrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(url('/petugas/detail_pengaduan/'.$msy->id_pengaduan)); ?>" class="btn btn-primary font-weight-bold">
                                    <i class="fas fa-search-plus"></i> <span class="d-none d-md-inline">Detail</span></a>
                                    <?php if($msy->status != 'selesai'): ?>
                                        <a href="<?php echo e(url('/petugas/tanggapan/'.$msy->id_pengaduan)); ?>" class="btn btn-success font-weight-bold">
...
<?php echo $__env->make('../tamplate_petugas', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Folder_iqbal\pengaduan_fix\resources\views/petugas/dashboard_petugas.blade.php ENDPATH**/ ?>