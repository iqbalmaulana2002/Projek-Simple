...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md">
            ...
            <form method="post" action="<?php echo e(url('/admin/tanggapan/'.$pengaduan->id_pengaduan)); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row float-right">
                    <div class="col-md mt-4 mb-5">
                        <a href="<?php echo e(url('/admin/detail_pengaduan/'.$pengaduan->id_pengaduan)); ?>" class="btn btn-outline-primary btn-light">Kembali</a>
...
<?php echo $__env->make('../tamplate_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Folder_iqbal\pengaduan_fix\resources\views/admin/tanggapan.blade.php ENDPATH**/ ?>