                    ...
                    <div class="signup-form">
                        ...
                        <form action="<?php echo e(url('/register')); ?>" method="POST" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="nik" id="nik" placeholder="Masukkan NIK Anda" autocomplete="off"/>
                            </div>
                            <div class="form-group">
...
<?php /**PATH D:\Folder_iqbal\pengaduan_fix\resources\views/register.blade.php ENDPATH**/ ?>