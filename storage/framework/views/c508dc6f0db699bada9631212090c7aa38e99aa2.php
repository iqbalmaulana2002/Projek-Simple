                    ...
                    <div class="signin-form">
                        ...
                        <?php echo csrf_field(); ?>
                            <div class="form-group">
                                ...
                                <input type="text" name="username" id="your_name" placeholder="Masukkan Username Akun Anda"/>
                            </div>
                            <div class="form-group">
                                <label for="your_pass"><i class="zmdi zmdi-lock"></i></label>
                                <input type="password" name="password" id="your_pass" placeholder="Masukkan Kata Sandi Anda"/>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\Ario\pengaduan_fix\resources\views/login.blade.php ENDPATH**/ ?>